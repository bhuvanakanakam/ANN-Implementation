...
from toy_problem_config import *
...
def generate_sine_data():
    ...
    x_train = train_data[:, :1] # first column of train_data (the input values).
    y_train = train_data[:, 1:2] # second column of train_data (the sine values).
...
plt.scatter(x_val[0],preds[0],color='green')
